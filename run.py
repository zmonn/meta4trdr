...
# allowed FX symbols
SYMBOLS = ['AUDCAD', 'AUDCHF', 'AUDJPY', 'AUDNZD', 'AUDUSD', 'AUDCNH', 'CADCHF', 'CADJPY', 'CHFJPY', 'EURAUD', 'EURCAD', 'EURCHF', 'EURGBP', 'EURHUF', 'EURJPY', 'EURNOK', 'EURNZD', 'EURSEK', 'EURUSD', 'GBPAUD', 'GBPCAD', 'GBPCHF', 'GBPJPY', 'GBPNZD', 'GBPUSD', 'NOW', 'NZDCAD', 'NZDCHF', 'NZDJPY', 'NZDUSD', 'USDCAD', 'USDCHF', 'USDJPY', 'USDZAR', 'XAGUSD', 'XAUUSD']
    ...
    try:
        ...
        if(enterTrade == True):
            ...
            try:
                ...
                update.effective_message.reply_text('open orders:', await connection.get_orders())
